...
class MainActivity : ComponentActivity() {
    ...
    private fun render() {
        ...
        if(connection!=null) {
            ...
            button(overview,"Overzicht openen",true){startActivity(Intent(this,OverviewActivity::class.java))}
            message?.let {label(content,it,14f,muted)}
            label(content,"Ritme 1.3 · jouw gegevens, jouw website",12f,muted)
            return
        }
