...
if (container && typeof Chart !== 'undefined') {
  ...
  draw('body_fat',data.days,[{key:'body_fat',label:'Lichaamsvet'}],'line',' %');
  draw('resting_hr',data.days,[{key:'resting_hr',label:'Rusthartslag'}],'line',' bpm');
  draw('calories_burned',data.weeks,[{key:'calories_burned',label:'Totaal verbrand'}],'bar',' kcal');
