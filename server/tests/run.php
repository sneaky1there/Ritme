...
rejects(fn()=>daily_input(['date'=>'2026-01-01','navel_cm'=>'2.2']),'out of range navel');
...
$d=daily_input(['date'=>'2026-01-01','navel_cm'=>'82,45']);
check($d['navel_cm']===82.45 && $d['hip_cm']===null,'decimal comma and missing values');
