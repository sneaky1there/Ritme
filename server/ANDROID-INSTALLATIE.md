...
3. Bestaande v1-database: importeer `sql/migrations/002_health_connect.sql` in phpMyAdmin. Nieuwe installatie: importeer het volledige `sql/install.sql`.
...
1. Open `Ritme-1.0.0.apk` op je Android-telefoon.
...
5. Kies **Toestemming kiezen** en geef toestemming voor de gewenste gegevenstypen: stappen, gewicht, slaap.
...
Handmatige stappen en gewichten hebben voorrang in dashboard/grafieken. De oorspronkelijke Health Connect-import is afzonderlijk zichtbaar in **Ruwe data**. Handmatig opgeslagen gegevens worden nooit door de telefoon overschreven.
...
De app bewaart geen lokale kopie van gezondheidsmetingen. De toegangssleutel is met Android Keystore versleuteld; cloudbackup en toesteloverdracht zijn uitgesloten. De website slaat alleen hashes van codes/tokens op. Coachlinks en telefoonsleutels zijn verschillende toegangsrechten: een telefoonsleutel kan geen coachoverzicht opvragen.
